...
public class KafkaConfiguration {
    ...
    @Bean
    public ProducerFactory<String, OrderEvent> producerConfig (ObjectMapper objectMapper){
...
//    *************************   Вариант с OrderEvent - не должен работать, а работает
    @Bean
...
//    *************************   Вариант со StatusEvent
//    @Bean
//    public ConsumerFactory<String, StatusEvent> consumerFactory(ObjectMapper objectMapper){
//        Map<String, Object> config = new HashMap<>();
//
//        config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
//        config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
...
//
//    @Bean
//    public ConcurrentKafkaListenerContainerFactory<String, StatusEvent> containerFactory(
//            ConsumerFactory<String, StatusEvent> consumerFactory
//    ) {
